...
export const LoginPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            addToast(tToast('loginSuccess'), 'success');
            const profile = useAuthStore.getState().userProfile;
            router.push(profile ? ROUTES.DASHBOARD : ROUTES.PROFILE_SETUP);
        } catch (err: unknown) {
            setError(err instanceof Error ? err.message : 'invalidCredentials');
        } finally {
            setLoading(false);
        }
    };
